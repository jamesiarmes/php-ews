 ...
 * 
 * Note: The NTLMStream class is not used here since we don't yet know
 * where to connect, and make many independent connections.
 * 
 * USAGE:
 * 
...
class EWSAutodiscover {
     ...
     * 
     * @param bool $skip To skip, or not.
     * @return self
     */
     ...
     * @return a known version constant, or FALSE if it could not be determined
     */
    ...
    /**
     * Static method may fail if there are issues surrounding SSL 
     * certificates. In such cases, set up the object as needed, and then 
     * call newEWS()
     * 
     * @param string $email
     * @param string $password
     ...
     * 
     * @param int $seconds Seconds to wait for a connection.
     * @return self
     */
     ...
     * @param int $timeout Overall cURL timeout for this request
     * @return bool
     */
    ...
    protected function nodeToArray($node)
    {
        ...
        switch ($node->nodeType) {
            ...
            case XML_ELEMENT_NODE:
                ...
                // edge case of a node containing a text node, 
                // which also has attributes. this way we'll retain text and 
