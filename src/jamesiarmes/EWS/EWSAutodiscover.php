 ...
 *
 * $ews = \jamesiarmes\EWS\EWSAutodiscover::getEWS($email, $password);
 *
 * -- OR --
 *
 ...
 *
 * $auto = new \jamesiarmes\EWS\EWSAutodiscover($email, $password);
 ...
 *
 * @package jamesiarmes\EWS\AutoDiscovery
 */
class EWSAutodiscover
{
    ...
    protected $versionMap = array(
        8 => array(
            ExchangeWebServices::VERSION_2007,
            ExchangeWebServices::VERSION_2007_SP1,
            ExchangeWebServices::VERSION_2007_SP2,
            ExchangeWebServices::VERSION_2007_SP3,
        ),
        14 => array(
            ExchangeWebServices::VERSION_2010,
            ExchangeWebServices::VERSION_2010_SP1,
    ...
    /**
     * Holds the last response to the EWS
     *
     * @var string
     */
    ...
    public function parseServerVersion($version_hex)
    {
        ...
        $ewsVersion =
            ($majorversion === 8) ?
                ExchangeWebServices::VERSION_2007 :
                ($majorversion === 14) ? ExchangeWebServices::VERSION_2010 : false;

        return empty($this->versionMap[$majorversion][$minorversion]) ?
            $ewsVersion :
            $this->versionMap[$majorversion][$minorversion];
    }
    ...
    {
        // TODO [lapistano]: iterate over different prefixes.
        /*
        $tldPrefixes = array('www', 'mail');
         */
        // $url = 'https://www.'.$this->tld . self::AUTODISCOVER_PATH;
        $url = 'https://mail.' . $this->tld . self::AUTODISCOVER_PATH;
