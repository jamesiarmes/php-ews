<?php
/**
 * Contains PullSubscriptionRequestType.
 */
 ...
 *
 * @todo Extend BaseSubscriptionRequestType.
 */
class PullSubscriptionRequestType extends EWSType
{
     ...
     *
     * This is used to create a subscription that starts at an event that is
     * represented by the watermark. If the watermark from a Subscribe request
     * is not found, an error response will be returned to the client. This
     * error may occur if the watermark is older than 30 days or if the
