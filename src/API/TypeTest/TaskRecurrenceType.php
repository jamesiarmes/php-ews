...
class TaskRecurrenceType extends Type
{
    ...
    /**
     * @property \jamesiarmes\PEWS\API\TypeTest\DailyRegeneratingPatternType
     * $dailyRegeneration
     */
    protected $dailyRegeneration = null;

    /**
     * @property \jamesiarmes\PEWS\API\TypeTest\WeeklyRegeneratingPatternType
     * $weeklyRegeneration
     */
    protected $weeklyRegeneration = null;

    /**
     * @property \jamesiarmes\PEWS\API\TypeTest\MonthlyRegeneratingPatternType
     * $monthlyRegeneration
     */
    protected $monthlyRegeneration = null;

    /**
     * @property \jamesiarmes\PEWS\API\TypeTest\YearlyRegeneratingPatternType
     * $yearlyRegeneration
     */
