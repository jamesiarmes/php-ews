 ...
 * @method FindMailboxStatisticsByKeywordsResponseMessageType setMailboxStatisticsSearchResult(\jamesiarmes\PEWS\API\TypeTest\MailboxStatisticsSearchResultType $mailboxStatisticsSearchResult)
 */
